...
import { IonApp, IonSplitPane, IonMenu, IonContent, IonList, IonListHeader, IonNote, IonMenuToggle, IonItem, IonIcon, IonLabel, IonInput, IonRouterOutlet } from '@ionic/angular/standalone';
...
@Component({
  ...
  standalone: true,
  imports: [FormsModule, ReactiveFormsModule, IonItem, IonLabel, IonInput]
})
